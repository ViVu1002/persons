...
SELECT ps.name, AVG(poi.point), COUNT(poi.subject_id) FROM `persons` AS ps , `points` AS poi WHERE poi.person_id = ps.id GROUP BY poi.person_id HAVING COUNT(poi.subject_id) =10
