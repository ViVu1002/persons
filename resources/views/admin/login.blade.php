    ...
    <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
        ...
        <div class="login-panel panel panel-default">
            ...
            <div class="panel-body">
                ...
                <input style="margin-left: 80px" type="submit" class="btn btn-success" value="Login">
                <a href="{{ url('user/create') }}" style="margin-left: 20px" type="submit" class="btn btn-primary">Register</a>
                <a href="{{ url('auth/google') }}" style="margin-left: 20px" type="submit" class="btn btn-info">Login google</a>
                {!! Form::close() !!}
            </div>
        </div>
    </div><!-- /.col-->
